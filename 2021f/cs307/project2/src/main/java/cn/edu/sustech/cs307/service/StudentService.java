...
public interface StudentService {
    ...
    enum EnrollResult {
        /**
         * Enrolled successfully 0
         */
        SUCCESS,
        /**
         * Cannot found the course section 1
         */
        COURSE_NOT_FOUND,
        /**
         * The course section is full 2
         */
        COURSE_IS_FULL,
        /**
         * The course section is already enrolled by the student 3
         */
        ALREADY_ENROLLED,
        /**
         * The course (of the section) is already passed by the student 4
         */
        ALREADY_PASSED,
        /**
         * The student misses prerequisites for the course 5
         */
        PREREQUISITES_NOT_FULFILLED,
        /**
         * The student's enrolled courses has time conflicts with the section,
         * or has course conflicts (same course) with the section. 6
         */
