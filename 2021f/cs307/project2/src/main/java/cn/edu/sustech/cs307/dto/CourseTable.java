...
public class CourseTable {
    ...
    @Override
    public String toString() {
        return table.get(DayOfWeek.MONDAY).toString()+"  "+table.get(DayOfWeek.TUESDAY).toString()+"  "+table.get(DayOfWeek.WEDNESDAY).toString()+"  "+table.get(DayOfWeek.THURSDAY).toString()+"  "+table.get(DayOfWeek.FRIDAY).toString()+"  "+table.get(DayOfWeek.SATURDAY).toString()+"  "+table.get(DayOfWeek.SUNDAY).toString();
    }
}
